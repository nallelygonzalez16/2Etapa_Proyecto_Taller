...
def ModificarListaRopa(persona):
    ...
    of the clothing the person owns and then shows you the list of clothing options that you can choose 
    from and then add it to the person's clothing.It presents a menu to the administrator through which 
    you can perform the same action again with the same sample person or end the action.
    ...
    print("                 ╔═══════════════════════════════════════╗\n"
          "                 ║                 MENÚ                  ║\n"
          "                 ╠═══════════════════════════════════════╣\n"
          "                 ║ Ingrese 1 para agregar otra prenda    ║\n"
          "                 ║ Ingrese 2 si desea terminar la accion ║\n"
          "                 ╚═══════════════════════════════════════╝")
    try:
        opcion=int(input("Digite la accion que desa realizar: "))
        if opcion == 1:
            print("\033[1;36m" + "──────────────────────────────────────────────────────────────────────────────────────────────────" + '\033[0;m')
            ModificarListaRopa(persona)
        if opcion == 2:
...
def ModificarListaAccesorios(persona):
    ...
    choose from and then add it to the person's accessories.It presents a menu to the administrator through 
    which you can perform the same action again with the same sample person or end the action.
    : parameter: receives the person to modify
    : returns: nothing is returned
    : exceptions: has no exceptions
    """
    ...
    print("                ╔═══════════════════════════════════════╗\n"
          "                ║                 MENÚ                  ║\n"
          "                ╠═══════════════════════════════════════╣\n"
          "                ║ Ingrese 1 para agregar otro accesorio ║\n"
          "                ║ Ingrese 2 si desea terminar la accion ║\n"
          "                ╚═══════════════════════════════════════╝")
    try:
        opcion=int(input("Digite la accion que desa realizar: "))
...
def ModificarCalzado(persona):
    ...
    choose from and then add it to the person's shoes.It presents a menu to the administrator through which you can perform 
    the same action again with the same sample person or end the action.
    : parameter: receives the person to modify
    : returns: nothing is returned
    : exceptions: has no exceptions
    """    
    ...
    print("                  ╔═════════════════════════════════════════════╗\n"
          "                  ║                 MENÚ                        ║\n"
          "                  ╠═════════════════════════════════════════════╣\n"
          "                  ║ Ingrese 1 para cambiar de nuevo el calzado  ║\n"
          "                  ║ Ingrese 2 si desea terminar la accion       ║\n"
          "                  ╚═════════════════════════════════════════════╝")
    try:
        opcion=int(input("Digite la accion que desa realizar: "))
